...
export const CONTACT_HREF = "https://wa.me/5549989040095"; // WhatsApp (49) 98904-0095

// Os projetos do feed abrem as demos ao vivo no subdomínio de demos.
export const demoHref = (slug: string) => `https://demos.nashpages.com.br/${slug}`;
